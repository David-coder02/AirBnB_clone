...
class TestFileStorage(unittest.TestCase):
    ...
    def help_test_reload(self, classname):
        """to test reload() method for classname."""
        self.resetStorage()
        storage.reload()
